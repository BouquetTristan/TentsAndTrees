		...
		if(@cliquable == true)
			...
			if(aide1 != nil)
				...
				for i in (0..uneGrille.taille-1)
					interfaceGrille[aide1][i].indiquerAide(monApp, uneGrille.grilleJ[aide1][i].etat)
				end
				return aide1
			elsif(aide2 != nil)
				...
				interfaceGrille[aide3.i][aide3.j].indiquerAide(monApp, uneGrille.grilleJ[aide3.i][aide3.j].etat)
				return aide3
			elsif(aide4 != nil)
				...
				interfaceGrille[aide4.i][aide4.j].indiquerAide(monApp, uneGrille.grilleJ[aide4.i][aide4.j].etat)
				return aide4
			elsif(aide5 != nil)
				...
				interfaceGrille[aide5.i][aide5.j].indiquerAide(monApp, uneGrille.grilleJ[aide5.i][aide5.j].etat)
				return aide5
			else
