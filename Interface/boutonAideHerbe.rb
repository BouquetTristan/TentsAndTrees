	...
	def aide(uneGrille, unLabel, unJoueur, interfaceGrille)
		if(@cliquable == true)
			...
			if(aide1 != nil)
				...
				unLabel.set_markup("<span foreground=\"#FFFFFF\" font-desc=\"Courier New bold 11\">La case  en #{aide5.i} #{aide5.j} ne dépend d'aucun arbre et est donc forcément de l'herbe</span>")
